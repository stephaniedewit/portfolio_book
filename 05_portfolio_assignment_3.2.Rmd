...
planning <- tibble("Stap" = 1:6, "Wat" = c("Oriënteren op de R packages die beschikbaar zijn voor LC-MS data analyse.","Twee á drie packages kiezen en hier verder in verdiepen.**","De packages proberen te installeren.", "Eén package kiezen en een tutorial o.i.d. over deze package volgen." ,"Het package zelf proberen toe te passen op andere data.", "Eigen code duidelijk uitschrijven in portfolio."), "Schatting tijdsbelasting" = c("2 uur","2,5 uur","2 uur","~ 8 uur"," ~ 10 uur","max. 4 uur"), "Werkelijke tijdsbelasting" = c("~ 1,5 uur","~ 1,5 uur","2 uur","11 uur"," 12,5 uur","~ 5 uur"))
